...
#echo "debug_mode=batch" >> $BIN_DIR/xrt.ini
echo "debug_mode=gui" >> $BIN_DIR/xrt.ini
...
#pushd $FSIM_VITIS_DIR/_x.hw_emu.xilinx_u250_gen3x16_xdma_3_1_202020_1/link/int/behav_waveform/xsim/
#
#./launch_hw_emu.sh $BIN_DIR/FireSim-vitis \
#    +permissive \
#        +macaddr0=00:00:00:00:00:02 \
#        +blkdev-in-mem0=128 \
#        +linklatency0=6405 \
...
#        +binary_file=$XCL_DIR/firesim.xclbin \
#    +permissive-off \
#    +prog0=/scratch/abejgonza/chipyard-work/chipyard/tests/helloWorld.riscv
#
#popd
